                ...
                <table id="example1" class="table table-bordered table-striped">
                  ...
                  ?>
                      <tr>
                        ...
                        <td>
                        <a href="<?php echo base_url(); ?>view-staff/<?php echo $cnt['id']; ?>" class="btn btn-success rounded-0 btn-sm text-xs" style="margin:1px"><i class="fa fa-eye"></i></a>
                          ...
                          <a href="<?php echo base_url(); ?>delete-staff/<?php echo $cnt['id']; ?>" class="btn btn-danger rounded-0 btn-sm text-xs" style="margin:1px"><i class="fa fa-trash"></i></a>
                        </td>
                      </tr>
                    <?php 
                      $i++;
