...
<!--                         <td>₹<?php //echo $cnt['basic_salary']; ?></td>
                        ...
                        <td><?php echo $cnt['month_slip']; ?></td>
                        <td><?php echo $cnt['year_slip']; ?></td>
                        <!-- <td><?php //echo date('Y-m-d', strtotime($cnt['added_on'])); ?></td> -->
                        <td><a href="<?php echo base_url(); ?>salary-invoice/<?php echo $cnt['id']; ?>" class="btn btn-warning">Salary Slip</a></td>
                        <td>
                          <a href="<?php echo base_url(); ?>delete-salary/<?php echo $cnt['id']; ?>" class="btn btn-danger rounded-0 btn-sm text-xs"><i class="fa fa-trash"></i></a>
                        </td>
                      </tr>
                    <?php 
                      $i++;
