...
class Leave extends CI_Controller{
    ...
    {
        $this->form_validation->set_rules('slleavetype', 'Leave Type', 'required');
        ...
        $staff=$this->session->userdata('userid');
        $leave=$this->input->post('slleavetype');
        ...
        $data=$this->Leave_model->insert_leave(array('staff_id'=>$staff,'leave-type'=>$leave,'leave_reason'=>$reason,'leave_from'=>$lfrom,'leave_to'=>$lto,'description'=>$desc,'applied_on'=>date('Y-m-d')));
        if($data==true)
        {
